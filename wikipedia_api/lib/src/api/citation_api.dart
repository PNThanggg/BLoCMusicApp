...
class CitationApi {
  CitationApi([ApiClient? apiClient]) : apiClient = apiClient ?? _defaultApiClient;
  ...
  Future<Response> getCitationWithHttpInfo(
    ...
    final path = r'/data/citation/{format}/{query}'.replaceAll('{format}', format).replaceAll('{query}', query);
