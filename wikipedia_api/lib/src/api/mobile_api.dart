...
class MobileApi {
  MobileApi([ApiClient? apiClient]) : apiClient = apiClient ?? _defaultApiClient;
  ...
  Future<Response> getSectionsLeadWithHttpInfo(
    ...
    final path = r'/page/mobile-sections-lead/{title}'.replaceAll('{title}', title);
  ...
  Future<Response> getSectionsRemainingWithHttpInfo(
    ...
    final path = r'/page/mobile-sections-remaining/{title}'.replaceAll('{title}', title);
