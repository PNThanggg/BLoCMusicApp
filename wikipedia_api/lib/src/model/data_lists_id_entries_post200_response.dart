...
class DataListsIdEntriesPost200Response {
  ...
  final ListEntryRead entry;

  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is DataListsIdEntriesPost200Response && other.id == id && other.entry == entry;

  @override
  int get hashCode => (id.hashCode) + (entry.hashCode);

  @override
  String toString() => 'DataListsIdEntriesPost200Response[id=$id, entry=$entry]';
    ...
    if (value is Map) {
      ...
      assert(() {
        for (String key in requiredKeys) {
          assert(json.containsKey(key), 'Required key "DataListsIdEntriesPost200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DataListsIdEntriesPost200Response[$key]" has a null value in JSON.');
        }
        return true;
      }());
  ...
  static Map<String, DataListsIdEntriesPost200Response> mapFromJson(dynamic json) {
