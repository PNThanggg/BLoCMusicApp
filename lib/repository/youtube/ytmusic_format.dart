    ...
    final List result = itemsList.map((e) {
      return {
        ...
        'image': e['defaultPromoPanelRenderer']['largeFormFactorBackgroundThumbnail']
            ...
            .last['url'],
        'images': e['defaultPromoPanelRenderer']['largeFormFactorBackgroundThumbnail']
                ['thumbnailLandscapePortraitRenderer']['landscape']['thumbnails']
            .map((e) => e['url'])
            .toList(),
        'provider': 'youtube'
  ...
  try {
    for (Map e in items) {
      if (e['lockupViewModel'] != null) {
        result.add({
          'title': e['lockupViewModel']['metadata']['lockupMetadataViewModel']['title']['content'],
          'type': 'playlist',
          'subtitle': e['lockupViewModel']['metadata']['lockupMetadataViewModel']['metadata']
              ['contentMetadataViewModel']['metadataRows'][0]['metadataParts'][0]['text']['content'],
          'count': e['lockupViewModel']['contentImage']['collectionThumbnailViewModel']['primaryThumbnail']
          ...
          'image': e['lockupViewModel']['contentImage']['collectionThumbnailViewModel']['primaryThumbnail']
              ['thumbnailViewModel']['image']['sources'][0]['url'],
          'isWide': (e['lockupViewModel']['contentImage']['collectionThumbnailViewModel']['primaryThumbnail']
                      ['thumbnailViewModel']['image']['sources'][0]['width'] !=
                  e['lockupViewModel']['contentImage']['collectionThumbnailViewModel']['primaryThumbnail']
                      ['thumbnailViewModel']['image']['sources'][0]['height'])
              ? true
              : false,
          'images': e['lockupViewModel']['contentImage']['collectionThumbnailViewModel']['primaryThumbnail']
