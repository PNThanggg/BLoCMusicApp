...
const menuLikeStatus = [...menu, 'topLevelButtons', 0, 'likeButtonRenderer', 'likeStatus'];
const menuService = ['menuServiceItemRenderer', 'serviceEndpoint'];
const toggleMenu = 'toggleMenuServiceItemRenderer';
const playButton = ['overlay', 'musicItemThumbnailOverlayRenderer', 'content', 'musicPlayButtonRenderer'];
const navigationBrowse = ['navigationEndpoint', 'browseEndpoint'];
const navigationBrowseId = [...navigationBrowse, 'browseId'];
const pageType = ['browseEndpointContextSupportedConfigs', 'browseEndpointContextMusicConfig', 'pageType'];
const navigationVideoId = ['navigationEndpoint', 'watchEndpoint', 'videoId'];
const navigationPlaylistId = ['navigationEndpoint', 'watchEndpoint', 'playlistId'];
const navigationWatchPlaylistId = ['navigationEndpoint', 'watchPlaylistEndpoint', 'playlistId'];
...
const carouselTitle = ['header', 'musicCarouselShelfBasicHeaderRenderer', 'title', 'runs', 0];
...
const frameworkMutations = ['frameworkUpdates', 'entityBatchUpdate', 'mutations'];
...
const thumbnailRenderer = ['thumbnailRenderer', 'musicThumbnailRenderer', ...thumbnail];
const thumbnailCropped = ['thumbnail', 'croppedSquareThumbnailRenderer', ...thumbnail];
const feedbackToken = ['feedbackEndpoint', 'feedbackToken'];
const badgePath = [0, 'musicInlineBadgeRenderer', 'accessibilityData', 'accessibilityData', 'label'];
const badgeLabel = ['badges', ...badgePath];
const subtitleBadgeLabel = ['subtitleBadges', ...badgePath];
const categoryTitle = ['musicNavigationButtonRenderer', 'buttonText', ...runText];
const categoryParams = ['musicNavigationButtonRenderer', 'clickCommand', 'browseEndpoint', 'params'];
...
const menuPlaylistId = [...menuItems, 0, 'menuNavigationItemRenderer', ...navigationWatchPlaylistId];
