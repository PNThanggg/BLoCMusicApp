...
List<MediaItemModel> fromYtVidSongMapList2MediaItemList(List<dynamic> songList) {
  List<MediaItemModel> mediaList = [];
  mediaList = songList.map((e) => fromYtVidSongMap2MediaItem(e as Map<dynamic, dynamic>)).toList();
  return mediaList;
}
