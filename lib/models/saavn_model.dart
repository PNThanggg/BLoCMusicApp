...
List<MediaItemModel> fromSaavnSongMapList2MediaItemList(List<dynamic> songList) {
  List<MediaItemModel> mediaList = [];
  mediaList = songList.map((e) => fromSaavnSongMap2MediaItem(e as Map<dynamic, dynamic>)).toList();
  return mediaList;
}

Future<String?> getJsQualityURL(
  String url, {
  bool isStreaming = true,
}) async {
  String? kUrl;

  // String ops = isStreaming ? GlobalStrConsts.strmQuality : GlobalStrConsts.downQuality;
