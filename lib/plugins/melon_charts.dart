...
class MelonChartsLinks {
  ...
  static const String GENREOMICS_DAILY = 'https://www.melon.com/chart/day/index.htm?classCd=GN0000';
  static const String DOMESTIC_DAILY = 'https://www.melon.com/chart/day/index.htm?classCd=DM0000';
  static const String OVERSEAS_DAILY = 'https://www.melon.com/chart/day/index.htm?classCd=AB0000';
  static const String GENREOMICS_WEEKLY = 'https://www.melon.com/chart/week/index.htm?classCd=GN0000';
  static const String DOMESTIC_WEEKLY = 'https://www.melon.com/chart/week/index.htm?classCd=DM0000';
  static const String OVERSEAS_WEEKLY = 'https://www.melon.com/chart/week/index.htm?classCd=AB0000';
  static const String GENREOMICS_MONTHLY = 'https://www.melon.com/chart/month/index.htm?classCd=GN0000';
  static const String DOMESTIC_MONTHLY = 'https://www.melon.com/chart/month/index.htm?classCd=DM0000';
  static const String OVERSEAS_MONTHLY = 'https://www.melon.com/chart/month/index.htm?classCd=AB0000';
}

class MelonCharts {
  static final ChartURL TOP_100 = ChartURL(title: "Melon\nTop 100", url: MelonChartsLinks.TOP_100);
  static final ChartURL HOT_100 = ChartURL(title: "Melon\nHot 100", url: MelonChartsLinks.HOT_100);
  static final ChartURL GENREOMICS_DAILY =
      ChartURL(title: "Melon\nGenremics Daily", url: MelonChartsLinks.GENREOMICS_DAILY);
  static final ChartURL DOMESTIC_DAILY = ChartURL(title: "Melon\nDomestic Daily", url: MelonChartsLinks.DOMESTIC_DAILY);
  static final ChartURL OVERSEAS_DAILY = ChartURL(title: "Melon\nOverseas Daily", url: MelonChartsLinks.OVERSEAS_DAILY);
  static final ChartURL GENREOMICS_WEEKLY =
      ChartURL(title: "Melon\nGenremics Weekly", url: MelonChartsLinks.GENREOMICS_WEEKLY);
  static final ChartURL DOMESTIC_WEEKLY =
      ChartURL(title: "Melon\nDomestic Weekly", url: MelonChartsLinks.DOMESTIC_WEEKLY);
  static final ChartURL OVERSEAS_WEEKLY =
      ChartURL(title: "Melon\nOverseas Weekly", url: MelonChartsLinks.OVERSEAS_WEEKLY);
  static final ChartURL GENREOMICS_MONTHLY =
      ChartURL(title: "Melon\nGenremics Monthly", url: MelonChartsLinks.GENREOMICS_MONTHLY);
  static final ChartURL DOMESTIC_MONTHLY =
      ChartURL(title: "Melon\nDomestic Monthly", url: MelonChartsLinks.DOMESTIC_MONTHLY);
  static final ChartURL OVERSEAS_MONTHLY =
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      for (final item in allItems) {
        ...
        final label = div.querySelector('div.ellipsis.rank02 span')?.text.trim();
        final img = item.querySelector('a.image_typeAll img')!.attributes['src']!;
      ...
      log('Melon Charts: ${melonChart.chartItems.length} tracks', name: "Melon");
      return melonChart;
    } else {
      ...
      //   return chart;
      // }
      throw Exception('Parsing failed with status code: ${response.statusCode}');
    }
  } catch (e) {
    // final chart = await BloomeeDBService.getChart(url.title);
    // if (chart != null) {
