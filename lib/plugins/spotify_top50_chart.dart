...
class SpotifyChartsLinks {
  static const String TOP_50 = 'https://charts-spotify-com-service.spotify.com/public/v0/charts';
}

class SpotifyCharts {
  static final ChartURL TOP_50 = ChartURL(title: "Spotify\nTop 50 Global", url: SpotifyChartsLinks.TOP_50);
}
...
Future<ChartModel> getSpotifyTop50Chart(ChartURL url) async {
  try {
    ...
    if (response.statusCode == 200) {
      ...
      log('Spotify Charts: ${chart.chartItems.length} tracks', name: "Spotify");
      return chart;
    } else {
